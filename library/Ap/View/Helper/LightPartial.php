...
class Ap_View_Helper_LightPartial extends Zend_View_Helper_Abstract
{
    /**
     ...
     */
    public function lightPartial($name = null, $module = null, $model = null)
    {
        if (0 == func_num_args()) {
            return $this;
        }
